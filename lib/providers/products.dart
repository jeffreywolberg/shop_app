...
class Products with ChangeNotifier {
  ...
  Future<void> addProduct(Product product) async {
    ...
    // _items.insert(0, Product(...)) // to add at start of list
  }
  ...
  Future<void> fetchAndSetProducts() async {
    try {
      ...
      // alternatively, use 'json.decode(response.body) as Map<String, dynamic>;'
  ...
  Future<void> removeProduct(String id) async {
    final String urlSpecific = url.split('.json')[0] + '/$id.json';
    ...
    final response = await http.delete(urlSpecific);
